...
export const transit_realtime = $root.transit_realtime = (() => {
    ...
    transit_realtime.FeedHeader = (function() {
         ...
         * @property {transit_realtime.IMercuryFeedHeader|null} [".transit_realtime.mercuryFeedHeader"] FeedHeader .transit_realtime.mercuryFeedHeader
         */
         ...
         * @member {transit_realtime.IMercuryFeedHeader|null|undefined} .transit_realtime.mercuryFeedHeader
         * @memberof transit_realtime.FeedHeader
         * @instance
         */
        ...
        FeedHeader.encode = function encode(message, writer) {
            ...
            if (message[".transit_realtime.mercuryFeedHeader"] != null && Object.hasOwnProperty.call(message, ".transit_realtime.mercuryFeedHeader"))
                $root.transit_realtime.MercuryFeedHeader.encode(message[".transit_realtime.mercuryFeedHeader"], writer.uint32(/* id 1001, wireType 2 =*/8010).fork()).ldelim();
            return writer;
        };
        ...
        FeedHeader.decode = function decode(reader, length, error) {
            ...
            while (reader.pos < end) {
                ...
                case 1001: {
                        message[".transit_realtime.mercuryFeedHeader"] = $root.transit_realtime.MercuryFeedHeader.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        FeedHeader.fromObject = function fromObject(object) {
            ...
            if (object[".transit_realtime.mercuryFeedHeader"] != null) {
                if (typeof object[".transit_realtime.mercuryFeedHeader"] !== "object")
                    throw TypeError(".transit_realtime.FeedHeader..transit_realtime.mercuryFeedHeader: object expected");
                message[".transit_realtime.mercuryFeedHeader"] = $root.transit_realtime.MercuryFeedHeader.fromObject(object[".transit_realtime.mercuryFeedHeader"]);
            }
            return message;
        };
        ...
        FeedHeader.toObject = function toObject(message, options) {
            ...
            if (message[".transit_realtime.mercuryFeedHeader"] != null && message.hasOwnProperty(".transit_realtime.mercuryFeedHeader"))
                object[".transit_realtime.mercuryFeedHeader"] = $root.transit_realtime.MercuryFeedHeader.toObject(message[".transit_realtime.mercuryFeedHeader"], options);
            return object;
        };
    ...
    transit_realtime.TripUpdate = (function() {
        ...
        TripUpdate.StopTimeEvent = (function() {
             ...
             * @property {number|null} [scheduledTime] StopTimeEvent scheduledTime
             */
        ...
        TripUpdate.StopTimeUpdate = (function() {
             ...
             * @property {transit_realtime.IMtaRailroadStopTimeUpdate|null} [".transit_realtime.mtaRailroadStopTimeUpdate"] StopTimeUpdate .transit_realtime.mtaRailroadStopTimeUpdate
             */
            ...
            /**
             * StopTimeUpdate .transit_realtime.mtaRailroadStopTimeUpdate.
             * @member {transit_realtime.IMtaRailroadStopTimeUpdate|null|undefined} .transit_realtime.mtaRailroadStopTimeUpdate
             * @memberof transit_realtime.TripUpdate.StopTimeUpdate
             * @instance
             */
            StopTimeUpdate.prototype[".transit_realtime.mtaRailroadStopTimeUpdate"] = null;
            ...
            StopTimeUpdate.encode = function encode(message, writer) {
                ...
                if (message[".transit_realtime.mtaRailroadStopTimeUpdate"] != null && Object.hasOwnProperty.call(message, ".transit_realtime.mtaRailroadStopTimeUpdate"))
                    $root.transit_realtime.MtaRailroadStopTimeUpdate.encode(message[".transit_realtime.mtaRailroadStopTimeUpdate"], writer.uint32(/* id 1005, wireType 2 =*/8042).fork()).ldelim();
                return writer;
            };
            ...
            StopTimeUpdate.decode = function decode(reader, length, error) {
                ...
                while (reader.pos < end) {
                    ...
                    case 1005: {
                            message[".transit_realtime.mtaRailroadStopTimeUpdate"] = $root.transit_realtime.MtaRailroadStopTimeUpdate.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            StopTimeUpdate.fromObject = function fromObject(object) {
                ...
                if (object[".transit_realtime.mtaRailroadStopTimeUpdate"] != null) {
                    if (typeof object[".transit_realtime.mtaRailroadStopTimeUpdate"] !== "object")
                        throw TypeError(".transit_realtime.TripUpdate.StopTimeUpdate..transit_realtime.mtaRailroadStopTimeUpdate: object expected");
                    message[".transit_realtime.mtaRailroadStopTimeUpdate"] = $root.transit_realtime.MtaRailroadStopTimeUpdate.fromObject(object[".transit_realtime.mtaRailroadStopTimeUpdate"]);
                }
                return message;
            };
            ...
            StopTimeUpdate.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    object[".transit_realtime.mtaRailroadStopTimeUpdate"] = null;
                }
                ...
                if (message[".transit_realtime.mtaRailroadStopTimeUpdate"] != null && message.hasOwnProperty(".transit_realtime.mtaRailroadStopTimeUpdate"))
                    object[".transit_realtime.mtaRailroadStopTimeUpdate"] = $root.transit_realtime.MtaRailroadStopTimeUpdate.toObject(message[".transit_realtime.mtaRailroadStopTimeUpdate"], options);
                return object;
            };
    ...
    transit_realtime.VehiclePosition = (function() {
        ...
        VehiclePosition.CarriageDetails = (function() {
             ...
             * @property {transit_realtime.IMtaRailroadCarriageDetails|null} [".transit_realtime.mtaRailroadCarriageDetails"] CarriageDetails .transit_realtime.mtaRailroadCarriageDetails
             */
            ...
            /**
             * CarriageDetails .transit_realtime.mtaRailroadCarriageDetails.
             * @member {transit_realtime.IMtaRailroadCarriageDetails|null|undefined} .transit_realtime.mtaRailroadCarriageDetails
             * @memberof transit_realtime.VehiclePosition.CarriageDetails
             * @instance
             */
            CarriageDetails.prototype[".transit_realtime.mtaRailroadCarriageDetails"] = null;
            ...
            CarriageDetails.encode = function encode(message, writer) {
                ...
                if (message[".transit_realtime.mtaRailroadCarriageDetails"] != null && Object.hasOwnProperty.call(message, ".transit_realtime.mtaRailroadCarriageDetails"))
                    $root.transit_realtime.MtaRailroadCarriageDetails.encode(message[".transit_realtime.mtaRailroadCarriageDetails"], writer.uint32(/* id 1005, wireType 2 =*/8042).fork()).ldelim();
                return writer;
            };
            ...
            CarriageDetails.decode = function decode(reader, length, error) {
                ...
                while (reader.pos < end) {
                    ...
                    case 1005: {
                            message[".transit_realtime.mtaRailroadCarriageDetails"] = $root.transit_realtime.MtaRailroadCarriageDetails.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            CarriageDetails.fromObject = function fromObject(object) {
                ...
                if (object[".transit_realtime.mtaRailroadCarriageDetails"] != null) {
                    if (typeof object[".transit_realtime.mtaRailroadCarriageDetails"] !== "object")
                        throw TypeError(".transit_realtime.VehiclePosition.CarriageDetails..transit_realtime.mtaRailroadCarriageDetails: object expected");
                    message[".transit_realtime.mtaRailroadCarriageDetails"] = $root.transit_realtime.MtaRailroadCarriageDetails.fromObject(object[".transit_realtime.mtaRailroadCarriageDetails"]);
                }
                return message;
            };
            ...
            CarriageDetails.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    object[".transit_realtime.mtaRailroadCarriageDetails"] = null;
                }
                if (message.id != null && message.hasOwnProperty("id"))
                    object.id = message.id;
                ...
                if (message[".transit_realtime.mtaRailroadCarriageDetails"] != null && message.hasOwnProperty(".transit_realtime.mtaRailroadCarriageDetails"))
                    object[".transit_realtime.mtaRailroadCarriageDetails"] = $root.transit_realtime.MtaRailroadCarriageDetails.toObject(message[".transit_realtime.mtaRailroadCarriageDetails"], options);
                return object;
            };
    ...
    transit_realtime.Alert = (function() {
         ...
         * @property {transit_realtime.IMercuryAlert|null} [".transit_realtime.mercuryAlert"] Alert .transit_realtime.mercuryAlert
         */
         ...
         * @member {transit_realtime.IMercuryAlert|null|undefined} .transit_realtime.mercuryAlert
         * @memberof transit_realtime.Alert
         * @instance
         */
        ...
        Alert.encode = function encode(message, writer) {
            ...
            if (message[".transit_realtime.mercuryAlert"] != null && Object.hasOwnProperty.call(message, ".transit_realtime.mercuryAlert"))
                $root.transit_realtime.MercuryAlert.encode(message[".transit_realtime.mercuryAlert"], writer.uint32(/* id 1001, wireType 2 =*/8010).fork()).ldelim();
            return writer;
        };
        ...
        Alert.decode = function decode(reader, length, error) {
            ...
            while (reader.pos < end) {
                ...
                case 1001: {
                        message[".transit_realtime.mercuryAlert"] = $root.transit_realtime.MercuryAlert.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        Alert.fromObject = function fromObject(object) {
            ...
            if (object[".transit_realtime.mercuryAlert"] != null) {
                if (typeof object[".transit_realtime.mercuryAlert"] !== "object")
                    throw TypeError(".transit_realtime.Alert..transit_realtime.mercuryAlert: object expected");
                message[".transit_realtime.mercuryAlert"] = $root.transit_realtime.MercuryAlert.fromObject(object[".transit_realtime.mercuryAlert"]);
            }
            return message;
        };
        ...
        Alert.toObject = function toObject(message, options) {
            ...
            if (message[".transit_realtime.mercuryAlert"] != null && message.hasOwnProperty(".transit_realtime.mercuryAlert"))
                object[".transit_realtime.mercuryAlert"] = $root.transit_realtime.MercuryAlert.toObject(message[".transit_realtime.mercuryAlert"], options);
            return object;
        };
    ...
    transit_realtime.EntitySelector = (function() {
         ...
         * @property {transit_realtime.IMercuryEntitySelector|null} [".transit_realtime.mercuryEntitySelector"] EntitySelector .transit_realtime.mercuryEntitySelector
         */
         ...
         * @member {transit_realtime.IMercuryEntitySelector|null|undefined} .transit_realtime.mercuryEntitySelector
         * @memberof transit_realtime.EntitySelector
         * @instance
         */
        ...
        EntitySelector.encode = function encode(message, writer) {
            ...
            if (message[".transit_realtime.mercuryEntitySelector"] != null && Object.hasOwnProperty.call(message, ".transit_realtime.mercuryEntitySelector"))
                $root.transit_realtime.MercuryEntitySelector.encode(message[".transit_realtime.mercuryEntitySelector"], writer.uint32(/* id 1001, wireType 2 =*/8010).fork()).ldelim();
            return writer;
        };
        ...
        EntitySelector.decode = function decode(reader, length, error) {
            ...
            while (reader.pos < end) {
                ...
                case 1001: {
                        message[".transit_realtime.mercuryEntitySelector"] = $root.transit_realtime.MercuryEntitySelector.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        EntitySelector.fromObject = function fromObject(object) {
            ...
            if (object[".transit_realtime.mercuryEntitySelector"] != null) {
                if (typeof object[".transit_realtime.mercuryEntitySelector"] !== "object")
                    throw TypeError(".transit_realtime.EntitySelector..transit_realtime.mercuryEntitySelector: object expected");
                message[".transit_realtime.mercuryEntitySelector"] = $root.transit_realtime.MercuryEntitySelector.fromObject(object[".transit_realtime.mercuryEntitySelector"]);
            }
            return message;
        };
        ...
        EntitySelector.toObject = function toObject(message, options) {
            ...
            if (message.directionId != null && message.hasOwnProperty("directionId"))
                object.directionId = message.directionId;
            if (message[".transit_realtime.mercuryEntitySelector"] != null && message.hasOwnProperty(".transit_realtime.mercuryEntitySelector"))
                object[".transit_realtime.mercuryEntitySelector"] = $root.transit_realtime.MercuryEntitySelector.toObject(message[".transit_realtime.mercuryEntitySelector"], options);
            return object;
        };
    ...
    transit_realtime.TripModifications = (function() {
        ...
        TripModifications.Modification = (function() {
             ...
             * @property {number|null} [lastModifiedTime] Modification lastModifiedTime
             */
    ...
    transit_realtime.MercuryFeedHeader = (function() {
         ...
         * @constructor
         * @param {transit_realtime.IMercuryFeedHeader=} [properties] Properties to set
         */
         ...
         * @memberof transit_realtime.MercuryFeedHeader
         * @static
         * @param {transit_realtime.IMercuryFeedHeader} message MercuryFeedHeader message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MercuryFeedHeader.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.transit_realtime.MercuryFeedHeader();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        MercuryFeedHeader.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/transit_realtime.MercuryFeedHeader";
        };
    ...
    transit_realtime.MercuryStationAlternative = (function() {
         ...
         * @constructor
         * @param {transit_realtime.IMercuryStationAlternative=} [properties] Properties to set
         */
         ...
         * @memberof transit_realtime.MercuryStationAlternative
         * @static
         * @param {transit_realtime.IMercuryStationAlternative} message MercuryStationAlternative message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MercuryStationAlternative.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.transit_realtime.MercuryStationAlternative();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        MercuryStationAlternative.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/transit_realtime.MercuryStationAlternative";
        };
    ...
    transit_realtime.MercuryAlert = (function() {
         ...
         * @property {number} createdAt MercuryAlert createdAt
         * @property {number} updatedAt MercuryAlert updatedAt
         * @property {string} alertType MercuryAlert alertType
         * @property {Array.<transit_realtime.IMercuryStationAlternative>|null} [stationAlternative] MercuryAlert stationAlternative
         ...
         * @property {number|null} [displayBeforeActive] MercuryAlert displayBeforeActive
         * @property {transit_realtime.ITranslatedString|null} [humanReadableActivePeriod] MercuryAlert humanReadableActivePeriod
         * @property {number|null} [directionality] MercuryAlert directionality
         ...
         * @constructor
         * @param {transit_realtime.IMercuryAlert=} [properties] Properties to set
         */
         ...
         * @member {Array.<transit_realtime.IMercuryStationAlternative>} stationAlternative
         * @memberof transit_realtime.MercuryAlert
         * @instance
         */
         ...
         * @member {number} displayBeforeActive
         * @memberof transit_realtime.MercuryAlert
         * @instance
         */
         ...
         * @memberof transit_realtime.MercuryAlert
         * @static
         * @param {transit_realtime.IMercuryAlert} message MercuryAlert message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MercuryAlert.encode = function encode(message, writer) {
            ...
            if (message.stationAlternative != null && message.stationAlternative.length)
                for (let i = 0; i < message.stationAlternative.length; ++i)
                    $root.transit_realtime.MercuryStationAlternative.encode(message.stationAlternative[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MercuryAlert.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.transit_realtime.MercuryAlert();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 4: {
                        ...
                        message.stationAlternative.push($root.transit_realtime.MercuryStationAlternative.decode(reader, reader.uint32()));
                        break;
                    }
                case 5: {
        ...
        MercuryAlert.fromObject = function fromObject(object) {
            ...
            if (object.stationAlternative) {
                ...
                for (let i = 0; i < object.stationAlternative.length; ++i) {
                    ...
                    message.stationAlternative[i] = $root.transit_realtime.MercuryStationAlternative.fromObject(object.stationAlternative[i]);
                }
            }
        ...
        MercuryAlert.toObject = function toObject(message, options) {
            ...
            if (message.stationAlternative && message.stationAlternative.length) {
                ...
                for (let j = 0; j < message.stationAlternative.length; ++j)
                    object.stationAlternative[j] = $root.transit_realtime.MercuryStationAlternative.toObject(message.stationAlternative[j], options);
            }
            if (message.servicePlanNumber && message.servicePlanNumber.length) {
                object.servicePlanNumber = [];
        ...
        MercuryAlert.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/transit_realtime.MercuryAlert";
        };
    ...
    transit_realtime.MercuryEntitySelector = (function() {
         ...
         * @constructor
         * @param {transit_realtime.IMercuryEntitySelector=} [properties] Properties to set
         */
         ...
         * @memberof transit_realtime.MercuryEntitySelector
         * @static
         * @param {transit_realtime.IMercuryEntitySelector} message MercuryEntitySelector message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MercuryEntitySelector.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.transit_realtime.MercuryEntitySelector();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        MercuryEntitySelector.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/transit_realtime.MercuryEntitySelector";
        };
    ...
    transit_realtime.MtaRailroadStopTimeUpdate = (function() {
         ...
         * @constructor
         * @param {transit_realtime.IMtaRailroadStopTimeUpdate=} [properties] Properties to set
         */
         ...
         * @member {string} track
         * @memberof transit_realtime.MtaRailroadStopTimeUpdate
         * @instance
         */
         ...
         * @static
         * @param {transit_realtime.IMtaRailroadStopTimeUpdate=} [properties] Properties to set
         * @returns {transit_realtime.MtaRailroadStopTimeUpdate} MtaRailroadStopTimeUpdate instance
         */
        ...
        /**
         * Encodes the specified MtaRailroadStopTimeUpdate message. Does not implicitly {@link transit_realtime.MtaRailroadStopTimeUpdate.verify|verify} messages.
         * @function encode
         * @memberof transit_realtime.MtaRailroadStopTimeUpdate
         * @static
         * @param {transit_realtime.IMtaRailroadStopTimeUpdate} message MtaRailroadStopTimeUpdate message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {transit_realtime.MtaRailroadStopTimeUpdate} MtaRailroadStopTimeUpdate
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MtaRailroadStopTimeUpdate.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.transit_realtime.MtaRailroadStopTimeUpdate();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        MtaRailroadStopTimeUpdate.fromObject = function fromObject(object) {
            if (object instanceof $root.transit_realtime.MtaRailroadStopTimeUpdate)
                return object;
            let message = new $root.transit_realtime.MtaRailroadStopTimeUpdate();
         ...
         * @memberof transit_realtime.MtaRailroadStopTimeUpdate
         * @static
         * @param {transit_realtime.MtaRailroadStopTimeUpdate} message MtaRailroadStopTimeUpdate
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        MtaRailroadStopTimeUpdate.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/transit_realtime.MtaRailroadStopTimeUpdate";
        };

        return MtaRailroadStopTimeUpdate;
    })();

    transit_realtime.MtaRailroadCarriageDetails = (function() {

        /**
         * Properties of a MtaRailroadCarriageDetails.
         * @memberof transit_realtime
         * @interface IMtaRailroadCarriageDetails
         * @property {number|null} [bicyclesAllowed] MtaRailroadCarriageDetails bicyclesAllowed
         * @property {string|null} [carriageClass] MtaRailroadCarriageDetails carriageClass
         * @property {transit_realtime.MtaRailroadCarriageDetails.QuietCarriage|null} [quietCarriage] MtaRailroadCarriageDetails quietCarriage
         * @property {transit_realtime.MtaRailroadCarriageDetails.ToiletFacilities|null} [toiletFacilities] MtaRailroadCarriageDetails toiletFacilities
         */

        /**
         * Constructs a new MtaRailroadCarriageDetails.
         * @memberof transit_realtime
         * @classdesc Represents a MtaRailroadCarriageDetails.
         * @implements IMtaRailroadCarriageDetails
         * @constructor
         * @param {transit_realtime.IMtaRailroadCarriageDetails=} [properties] Properties to set
         */
        function MtaRailroadCarriageDetails(properties) {
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * MtaRailroadCarriageDetails bicyclesAllowed.
         * @member {number} bicyclesAllowed
         * @memberof transit_realtime.MtaRailroadCarriageDetails
         * @instance
         */
        MtaRailroadCarriageDetails.prototype.bicyclesAllowed = 0;

        /**
         * MtaRailroadCarriageDetails carriageClass.
         * @member {string} carriageClass
         * @memberof transit_realtime.MtaRailroadCarriageDetails
         * @instance
         */
        MtaRailroadCarriageDetails.prototype.carriageClass = "";

        /**
         * MtaRailroadCarriageDetails quietCarriage.
         * @member {transit_realtime.MtaRailroadCarriageDetails.QuietCarriage} quietCarriage
         * @memberof transit_realtime.MtaRailroadCarriageDetails
         * @instance
         */
        MtaRailroadCarriageDetails.prototype.quietCarriage = 0;

        /**
         * MtaRailroadCarriageDetails toiletFacilities.
         * @member {transit_realtime.MtaRailroadCarriageDetails.ToiletFacilities} toiletFacilities
         * @memberof transit_realtime.MtaRailroadCarriageDetails
         * @instance
         */
        MtaRailroadCarriageDetails.prototype.toiletFacilities = 0;

        /**
         * Creates a new MtaRailroadCarriageDetails instance using the specified properties.
         * @function create
         * @memberof transit_realtime.MtaRailroadCarriageDetails
         * @static
         * @param {transit_realtime.IMtaRailroadCarriageDetails=} [properties] Properties to set
         * @returns {transit_realtime.MtaRailroadCarriageDetails} MtaRailroadCarriageDetails instance
         */
        MtaRailroadCarriageDetails.create = function create(properties) {
            return new MtaRailroadCarriageDetails(properties);
        };

        /**
         * Encodes the specified MtaRailroadCarriageDetails message. Does not implicitly {@link transit_realtime.MtaRailroadCarriageDetails.verify|verify} messages.
         * @function encode
         * @memberof transit_realtime.MtaRailroadCarriageDetails
         * @static
         * @param {transit_realtime.IMtaRailroadCarriageDetails} message MtaRailroadCarriageDetails message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MtaRailroadCarriageDetails.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.bicyclesAllowed != null && Object.hasOwnProperty.call(message, "bicyclesAllowed"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.bicyclesAllowed);
            if (message.carriageClass != null && Object.hasOwnProperty.call(message, "carriageClass"))
                writer.uint32(/* id 2, wireType 2 =*/18).string(message.carriageClass);
            if (message.quietCarriage != null && Object.hasOwnProperty.call(message, "quietCarriage"))
                writer.uint32(/* id 3, wireType 0 =*/24).int32(message.quietCarriage);
            if (message.toiletFacilities != null && Object.hasOwnProperty.call(message, "toiletFacilities"))
                writer.uint32(/* id 4, wireType 0 =*/32).int32(message.toiletFacilities);
            return writer;
        };

        /**
         * Decodes a MtaRailroadCarriageDetails message from the specified reader or buffer.
         * @function decode
         * @memberof transit_realtime.MtaRailroadCarriageDetails
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {transit_realtime.MtaRailroadCarriageDetails} MtaRailroadCarriageDetails
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MtaRailroadCarriageDetails.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.transit_realtime.MtaRailroadCarriageDetails();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 3: {
                        message.quietCarriage = reader.int32();
                        break;
                    }
                case 4: {
                        message.toiletFacilities = reader.int32();
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        /**
         * Creates a MtaRailroadCarriageDetails message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof transit_realtime.MtaRailroadCarriageDetails
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {transit_realtime.MtaRailroadCarriageDetails} MtaRailroadCarriageDetails
         */
        MtaRailroadCarriageDetails.fromObject = function fromObject(object) {
            if (object instanceof $root.transit_realtime.MtaRailroadCarriageDetails)
                return object;
            let message = new $root.transit_realtime.MtaRailroadCarriageDetails();
            if (object.bicyclesAllowed != null)
                message.bicyclesAllowed = object.bicyclesAllowed | 0;
            if (object.carriageClass != null)
                message.carriageClass = String(object.carriageClass);
            switch (object.quietCarriage) {
            default:
                if (typeof object.quietCarriage === "number") {
                    message.quietCarriage = object.quietCarriage;
                    break;
                }
                break;
            case "UNKNOWN_QUIET_CARRIAGE":
            case 0:
                message.quietCarriage = 0;
                break;
            case "QUIET_CARRIAGE":
            case 1:
                message.quietCarriage = 1;
                break;
            case "NOT_QUIET_CARRIAGE":
            case 2:
                message.quietCarriage = 2;
                break;
            }
            switch (object.toiletFacilities) {
            default:
                if (typeof object.toiletFacilities === "number") {
                    message.toiletFacilities = object.toiletFacilities;
                    break;
                }
                break;
            case "UNKNOWN_TOILET_FACILITIES":
            case 0:
                message.toiletFacilities = 0;
                break;
            case "TOILET_ONBOARD":
            case 1:
                message.toiletFacilities = 1;
                break;
            case "NO_TOILET_ONBOARD":
            case 2:
                message.toiletFacilities = 2;
                break;
            }
            return message;
        };
        ...
        /**
         * Creates a plain object from a MtaRailroadCarriageDetails message. Also converts values to other types if specified.
         * @function toObject
         * @memberof transit_realtime.MtaRailroadCarriageDetails
         * @static
         * @param {transit_realtime.MtaRailroadCarriageDetails} message MtaRailroadCarriageDetails
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MtaRailroadCarriageDetails.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (options.defaults) {
                object.bicyclesAllowed = 0;
                object.carriageClass = "";
                object.quietCarriage = options.enums === String ? "UNKNOWN_QUIET_CARRIAGE" : 0;
                object.toiletFacilities = options.enums === String ? "UNKNOWN_TOILET_FACILITIES" : 0;
            }
            if (message.bicyclesAllowed != null && message.hasOwnProperty("bicyclesAllowed"))
                object.bicyclesAllowed = message.bicyclesAllowed;
            if (message.carriageClass != null && message.hasOwnProperty("carriageClass"))
                object.carriageClass = message.carriageClass;
            if (message.quietCarriage != null && message.hasOwnProperty("quietCarriage"))
                object.quietCarriage = options.enums === String ? $root.transit_realtime.MtaRailroadCarriageDetails.QuietCarriage[message.quietCarriage] === undefined ? message.quietCarriage : $root.transit_realtime.MtaRailroadCarriageDetails.QuietCarriage[message.quietCarriage] : message.quietCarriage;
            if (message.toiletFacilities != null && message.hasOwnProperty("toiletFacilities"))
                object.toiletFacilities = options.enums === String ? $root.transit_realtime.MtaRailroadCarriageDetails.ToiletFacilities[message.toiletFacilities] === undefined ? message.toiletFacilities : $root.transit_realtime.MtaRailroadCarriageDetails.ToiletFacilities[message.toiletFacilities] : message.toiletFacilities;
            return object;
        };

        /**
         * Converts this MtaRailroadCarriageDetails to JSON.
         * @function toJSON
         * @memberof transit_realtime.MtaRailroadCarriageDetails
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        MtaRailroadCarriageDetails.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for MtaRailroadCarriageDetails
         * @function getTypeUrl
         * @memberof transit_realtime.MtaRailroadCarriageDetails
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MtaRailroadCarriageDetails.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/transit_realtime.MtaRailroadCarriageDetails";
        };

        /**
         * QuietCarriage enum.
         * @name transit_realtime.MtaRailroadCarriageDetails.QuietCarriage
         * @enum {number}
         * @property {number} UNKNOWN_QUIET_CARRIAGE=0 UNKNOWN_QUIET_CARRIAGE value
         * @property {number} QUIET_CARRIAGE=1 QUIET_CARRIAGE value
         * @property {number} NOT_QUIET_CARRIAGE=2 NOT_QUIET_CARRIAGE value
         */
        MtaRailroadCarriageDetails.QuietCarriage = (function() {
            const valuesById = {}, values = Object.create(valuesById);
            values[valuesById[0] = "UNKNOWN_QUIET_CARRIAGE"] = 0;
            values[valuesById[1] = "QUIET_CARRIAGE"] = 1;
            values[valuesById[2] = "NOT_QUIET_CARRIAGE"] = 2;
            return values;
        })();

        /**
         * ToiletFacilities enum.
         * @name transit_realtime.MtaRailroadCarriageDetails.ToiletFacilities
         * @enum {number}
         * @property {number} UNKNOWN_TOILET_FACILITIES=0 UNKNOWN_TOILET_FACILITIES value
         * @property {number} TOILET_ONBOARD=1 TOILET_ONBOARD value
         * @property {number} NO_TOILET_ONBOARD=2 NO_TOILET_ONBOARD value
         */
        MtaRailroadCarriageDetails.ToiletFacilities = (function() {
            const valuesById = {}, values = Object.create(valuesById);
            values[valuesById[0] = "UNKNOWN_TOILET_FACILITIES"] = 0;
            values[valuesById[1] = "TOILET_ONBOARD"] = 1;
            values[valuesById[2] = "NO_TOILET_ONBOARD"] = 2;
            return values;
        })();

        return MtaRailroadCarriageDetails;
    })();
